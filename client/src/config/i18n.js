export default {
  ...
  en: {
    ...
    event: {
      ...
      endTimeBeforeStartTime: "Watch out! Final time is before the start time",
      dayCancelledByHours: "Day canceled ()",
      dayCancelledByBlockedPeriods: "Día anulado",
      cancelInvalidDaysAlert: "Cancel days with the final time before the start time?",
      cancelInvalidDaysMessage: "There are some days where the final time is before the start time. Do you want to cancel those days?",
  ...
  es: {
    ...
    event: {
      ...
      endTimeBeforeStartTime: "¡Cuidado! La hora final es anterior a la de inicio",
      dayCancelledByHours: "Día anulado (hora inicio = hora final)",
      dayCancelledByBlockedPeriods: "Día anulado (ninguna hora disponible)",
      cancelInvalidDaysAlert: "¿Anular días con la hora final anterior a la de inicio?",
      cancelInvalidDaysMessage: "Hay algunos días donde la hora final es anterior a la hora de inicio. ¿Desea anularlos?",
